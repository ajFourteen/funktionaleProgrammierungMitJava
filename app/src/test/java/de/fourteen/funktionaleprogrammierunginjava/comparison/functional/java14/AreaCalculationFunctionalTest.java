...
import static de.fourteen.funktionaleprogrammierunginjava.comparison.functional.java14.AreaCalculationFunctional.areaCalculationFunctional;
...
final class AreaCalculationFunctionalTest implements AreaCalculationTest {
    ...
    void setUp() {
        ...
        sut = areaCalculationFunctional.apply(consoleSpy::println);
    }
